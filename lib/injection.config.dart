...
import 'application/notes/watcher/notes_watcher_bloc.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i7.INoteRepository>(
      () => _i8.NotesRepository(get<_i9.FirebaseFirestore>()));
  gh.factory<_i10.NotesActorBloc>(
      () => _i10.NotesActorBloc(get<_i7.INoteRepository>()));
  gh.factory<_i11.NotesWatcherBloc>(
      () => _i11.NotesWatcherBloc(get<_i7.INoteRepository>()));
